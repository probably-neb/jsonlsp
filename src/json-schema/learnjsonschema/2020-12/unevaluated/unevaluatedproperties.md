...
The [`unevaluatedProperties`](unevaluatedproperties.md) keyword is a generalisation of
the [`additionalProperties`](../applicator/additionalproperties.md) keyword that considers related keywords even when they are not direct
siblings of this keyword. More specifically, this keyword is affected by
occurrences of [`properties`](../applicator/properties.md),
[`patternProperties`](../applicator/patternproperties.md),
[`additionalProperties`](../applicator/additionalproperties.md), and [`unevaluatedProperties`](unevaluatedproperties.md) itself, as long as the
evaluate path that led to [`unevaluatedProperties`](unevaluatedproperties.md) is a _prefix_ of the evaluate
path of the others.
...
> [`properties`](../applicator/properties.md) or
> [`patternProperties`](../applicator/patternproperties.md)
> keywords behind conditional logic without duplicating the
> [`additionalProperties`](../applicator/additionalproperties.md) keyword in every possible branch. (2) Reusing
> helpers that consist of the [`properties`](../applicator/properties.md), [`patternProperties`](../applicator/patternproperties.md), or [`additionalProperties`](../applicator/additionalproperties.md) keywords, while specialising
