...
The [`contentEncoding`](contentEncoding.md) keyword signifies
...
> **Best Practice:**
> It is recommended to set this keyword along with the [`contentMediaType`](contentmediatype.md) keyword to declare the type of data
