...
The [`format`](format.md) keyword communicates that string instances are of the given
...
> [`pattern`](../validation/pattern.md) keyword. This guarantees
...
> Assertion](../format-assertion.md) vocabulary. However, this vocabulary is
