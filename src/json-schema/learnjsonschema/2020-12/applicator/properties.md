...
- Original: [https://www.learnjsonschema.com/2020-12/applicator/properties/](https://www.learnjsonschema.com/2020-12/applicator/properties/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/applicator/properties.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/applicator/properties.markdown)
- Specification: [https://json-schema.org/draft/2020-12/json-schema-core.html#section-10.3.2.1](https://json-schema.org/draft/2020-12/json-schema-core.html#section-10.3.2.1)
- Metaschema: `https://json-schema.org/draft/2020-12/meta/applicator`
- Introduced in: `draft1`

Validation succeeds if, for each name that appears in both the instance and as a name within this keyword's value, the child instance for that name successfully validates against the corresponding schema.

The [`properties`](properties.md) keyword restricts
...
> must use the [`required`](../validation/required.md) keyword
> accordingly.  
...
> the [`required`](../validation/required.md) keyword. However, setting properties defined by this keyword to the
