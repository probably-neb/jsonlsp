...
The [`prefixItems`](../prefixItems/index.md) keyword restricts a
...
[`prefixItems`](../prefixItems/index.md) array, if any.  Information
...
[`prefixItems`](../prefixItems/index.md) keyword is evaluated against
the [`items`](../items/index.md) keyword, if present.
...
> such items will be validated. If needed, use the [`minItems`](../../validation/minitems/index.md) and the [`maxItems`](../../validation/maxitems/index.md) keywords to assert on the bounds of the
> array.
