...
[`minContains`](../validation/mincontains.md) and
[`maxContains`](../validation/maxcontains.md) keywords.
...
> against the [`contains`](contains.md) subschema (and neither
> [`minContains`](../validation/mincontains.md) nor
> [`maxContains`](../validation/maxcontains.md) are declared, for
