...
- Original: [https://www.learnjsonschema.com/2020-12/applicator/if/](https://www.learnjsonschema.com/2020-12/applicator/if/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/applicator/if.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/applicator/if.markdown)
- Specification: [https://json-schema.org/draft/2020-12/json-schema-core.html#section-10.2.2.1](https://json-schema.org/draft/2020-12/json-schema-core.html#section-10.2.2.1)
- Metaschema: `https://json-schema.org/draft/2020-12/meta/applicator`
- Introduced in: `draft7`

This keyword declares a condition based on the validation result of the given schema.

The [`if`](index.md) keyword introduces a
subschema whose evaluation result restricts instances to validate against the
[`then`](../then/index.md) or {{<link keyword="else"
...
> **Digging Deeper:**
>  This keyword has no effect if neither the [`then`](../../../then/index.md) nor [`else`](../../../else/index.md) keywords are declared within the
...
The [`if`](index.md), {{<link keyword="then"
