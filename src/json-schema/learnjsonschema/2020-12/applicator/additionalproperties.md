...
The [`additionalProperties`](additionalProperties.md)
...
> enforce the presence of certain properties, you must use the [`required`](../validation/required.md) keyword accordingly.
