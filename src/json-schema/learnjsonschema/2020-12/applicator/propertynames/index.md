...
- Original: [https://www.learnjsonschema.com/2020-12/applicator/propertynames/](https://www.learnjsonschema.com/2020-12/applicator/propertynames/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/applicator/propertyNames.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/applicator/propertyNames.markdown)
- Specification: [https://json-schema.org/draft/2020-12/json-schema-core.html#section-10.3.2.4](https://json-schema.org/draft/2020-12/json-schema-core.html#section-10.3.2.4)
- Metaschema: `https://json-schema.org/draft/2020-12/meta/applicator`
- Introduced in: `draft6`

Validation succeeds if the schema validates against every property name in the instance.

The [`propertyNames`](../propertyNames/index.md) keyword restricts
...
[`properties`](../properties/index.md) and
...
> [`properties`](../properties/index.md) keyword) is either
> meaningless or leads to unsatisfiable schemas. Conversely, explicitly setting
> the [`type`](../../validation/type/index.md) keyword to `string` is redundant.
...
> explicitly listing every permitted property using the [`properties`](../properties/index.md) or [`patternProperties`](../patternproperties/index.md) keywords, and potentially closing
> the object by setting the [`additionalProperties`](../additionalproperties/index.md) keyword to `false`.  
