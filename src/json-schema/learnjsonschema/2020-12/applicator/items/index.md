...
The [`items`](index.md) keyword restricts array instance
items not described by the _sibling_ [`prefixItems`](../prefixitems/index.md) keyword (if any), to validate against the
...
> empty. If needed, use the [`minItems`](../../validation/minitems/index.md) keyword to assert on the minimum bounds of the array.
