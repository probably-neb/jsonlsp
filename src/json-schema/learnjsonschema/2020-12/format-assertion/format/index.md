...
The [`format`](../../format-annotation/format/index.md) keyword restricts string instances to the given logical type and
...
cases, it is advised to stick to the [`Format-Annotation`](../../format-annotation/format/index.md) variant of this keyword.
