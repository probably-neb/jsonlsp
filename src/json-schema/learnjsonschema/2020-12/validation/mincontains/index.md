...
- Original: [https://www.learnjsonschema.com/2020-12/validation/mincontains/](https://www.learnjsonschema.com/2020-12/validation/mincontains/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/validation/minContains.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/validation/minContains.markdown)
- Specification: [https://json-schema.org/draft/2020-12/json-schema-validation.html#section-6.4.5](https://json-schema.org/draft/2020-12/json-schema-validation.html#section-6.4.5)
- Metaschema: `https://json-schema.org/draft/2020-12/meta/validation`
- Introduced in: `2019-09`

The number of times that the [`contains`](/2020-12/applicator/contains) keyword (if set) successfully validates against the instance must be greater than or equal to the given integer.

The [`minContains`](../minContains/index.md) keyword modifies the [`contains`](../../applicator/contains/index.md) keyword to constrain array instances to the
given minimum number of containment matches. This keyword has no effect if the
[`contains`](../../applicator/contains/index.md) keyword is not declared.
...
> against the [`contains`](../../applicator/contains/index.md) subschema
> and [`minContains`](../minContains/index.md) is set to to 2. When not collecting annotations, validation
