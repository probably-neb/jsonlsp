...
- Original: [https://www.learnjsonschema.com/2020-12/validation/maxcontains/](https://www.learnjsonschema.com/2020-12/validation/maxcontains/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/validation/maxContains.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/validation/maxContains.markdown)
- Specification: [https://json-schema.org/draft/2020-12/json-schema-validation.html#section-6.4.4](https://json-schema.org/draft/2020-12/json-schema-validation.html#section-6.4.4)
- Metaschema: `https://json-schema.org/draft/2020-12/meta/validation`
- Introduced in: `2019-09`

The number of times that the [`contains`](/2020-12/applicator/contains) keyword (if set) successfully validates against the instance must be less than or equal to the given integer.

The [`maxContains`](../maxContains/index.md) keyword modifies the [`contains`](../../applicator/contains/index.md) keyword to constrain array instances to the
given maximum number of containment matches. This keyword has no effect if the
[`contains`](../../applicator/contains/index.md) keyword is not
declared.

> **Digging Deeper:**
> Using [`contains`](../../applicator/contains/index.md) with both [`minContains`](../mincontains/index.md)
> and [`maxContains`](index.md) set to the
...
> subschema without making use of the [`not`](../../applicator/not/index.md) applicator.
