...
> keyword. The [`required`](required.md) keyword mandates that certain properties are present
> (independently of their value), while the [`properties`](../applicator/properties.md) keyword describes the value of such
