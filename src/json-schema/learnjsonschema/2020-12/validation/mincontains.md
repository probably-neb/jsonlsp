...
The [`minContains`](minContains.md) keyword modifies the [`contains`](../applicator/contains.md) keyword to constrain array instances to the
given minimum number of containment matches. This keyword has no effect if the
[`contains`](../applicator/contains.md) keyword is not declared.
...
> and [`minContains`](minContains.md) is set to to 2. When not collecting annotations, validation
