...
- Original: [https://www.learnjsonschema.com/2020-12/core/schema/](https://www.learnjsonschema.com/2020-12/core/schema/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/core/schema.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/core/schema.markdown)
- Specification: [https://json-schema.org/draft/2020-12/json-schema-core.html#section-8.1.1](https://json-schema.org/draft/2020-12/json-schema-core.html#section-8.1.1)
...
The [`$schema`](index.md) keyword serves to explicitly associate a
...
[`$schema`](index.md) keyword is not declared, the schema inherits
its context-specific or implementation-specific default dialect.

> **Digging Deeper:**
>  It is common to avoid the [`$schema`](index.md)
...
> [`$schema`](index.md) keyword. This ensures that less strict
> implementations unambiguously know how to process the schema and don't attempt
> to guess.

Note that the [`$schema`](index.md) keyword can occur multiple
...
> circular problem.
>
> A common occurrence of this issue is setting the [`$schema`](index.md)
...
To debug the role of the [`$schema`](index.md) keyword on a schema
