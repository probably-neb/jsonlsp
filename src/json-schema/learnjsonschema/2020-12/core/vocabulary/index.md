...
The [`$vocabulary`](index.md) keyword is a _mandatory_ component of a dialect meta-schema
...
must explicitly state the vocabularies it imports using the [`$vocabulary`](index.md)
keyword.

> **Common Pitfall:**
> Declaring the [`$vocabulary`](index.md) keyword in a schema does not
> grant that same schema access to such vocabularies. Instead, the [`$vocabulary`](index.md)
...
> [dynamic anchor](../dynamicanchor/index.md) called `meta`. This
