...
The [`$id`](index.md) keyword explicitly turns a schema into a _schema
...
[`$id`](index.md) keyword (applicable in the case of compound schemas),
...
To debug the role of the [`$id`](index.md) keyword on a schema
