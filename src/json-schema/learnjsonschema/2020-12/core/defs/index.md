...
The [`$defs`](index.md) keyword is a container for storing reusable
schemas within a schema resource, which can be referenced using the
[`$ref`](../ref/index.md) or [`$dynamicRef`](../dynamicref/index.md) keywords. From a software engineering point of
