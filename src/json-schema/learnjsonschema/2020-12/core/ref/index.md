...
- Original: [https://www.learnjsonschema.com/2020-12/core/ref/](https://www.learnjsonschema.com/2020-12/core/ref/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/core/ref.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2020-12/core/ref.markdown)
...
The [`$ref`](index.md) keyword enables a schema to reference another schema by its URI,
...
> and referencing purposes is through the [`$id`](../id/index.md)
> keyword.
...
> be a subschema.  For example, referencing the contents of the [`examples`](../../meta-data/examples/index.md) keyword.
...
[`$id`](../id/index.md) keyword, or the base URI as determined
...
version of such URI through keywords such as [`$id`](../id/index.md) and [`$anchor`](../anchor/index.md). If so, the reference
