...
The [`$dynamicAnchor`](index.md) keyword is an
extension of the [`$anchor`](../anchor/index.md) keyword that
...
resolving a dynamic anchor using the [`$dynamicRef`](../dynamicref/index.md) keyword, the base URI of the origin is not
