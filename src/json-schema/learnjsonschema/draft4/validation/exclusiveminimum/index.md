...
The [`exclusiveMinimum`](index.md)
keyword is a boolean modifier for the [`minimum`](../minimum/index.md) keyword. When set to `true`, it changes the
validation behavior of the [`minimum`](../minimum/index.md)
keyword from _greater than or equal to_ to _strictly greater than_. This
keyword has no effect if the [`minimum`](../minimum/index.md) keyword is not present in the same schema.
