...
The [`exclusiveMaximum`](index.md)
keyword is a boolean modifier for the [`maximum`](../maximum/index.md) keyword. When set to `true`, it changes the
validation behavior of the [`maximum`](../maximum/index.md)
keyword from _less than or equal to_ to _strictly less than_. This keyword has
no effect if the [`maximum`](../maximum/index.md) keyword
