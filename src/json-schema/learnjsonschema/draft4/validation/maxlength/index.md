...
- Original: [https://www.learnjsonschema.com/draft4/validation/maxlength/](https://www.learnjsonschema.com/draft4/validation/maxlength/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft4/validation/maxLength.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft4/validation/maxLength.markdown)
- Specification: [https://json-schema.org/draft-04/draft-fge-json-schema-validation-00#rfc.section.5.2.1](https://json-schema.org/draft-04/draft-fge-json-schema-validation-00#rfc.section.5.2.1)
- Metaschema: `http://json-schema.org/draft-04/schema#`
- Introduced in: `draft1`

A string instance is valid against this keyword if its length is less than, or equal to, the value of this keyword.

The [`maxLength`](index.md) keyword restricts string instances to consists of an inclusive
...
> using the [`enum`](../enum/index.md) keyword with a single
> empty string value instead of setting this keyword to `0`. 
