...
- Original: [https://www.learnjsonschema.com/draft3/core/additionalproperties/](https://www.learnjsonschema.com/draft3/core/additionalproperties/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft3/core/additionalProperties.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft3/core/additionalProperties.markdown)
- Specification: [https://json-schema.org/draft-03/draft-zyp-json-schema-03.pdf#5.4](https://json-schema.org/draft-03/draft-zyp-json-schema-03.pdf#5.4)
...
described by the _sibling_ [`properties`](../properties/index.md) and [`patternProperties`](../patternproperties/index.md) keywords (if any), to validate against the given subschema.
