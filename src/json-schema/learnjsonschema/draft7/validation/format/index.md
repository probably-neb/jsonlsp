...
- Original: [https://www.learnjsonschema.com/draft7/validation/format/](https://www.learnjsonschema.com/draft7/validation/format/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/format.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/format.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.7](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.7)
- Metaschema: `http://json-schema.org/draft-07/schema#`
- Introduced in: `draft1`

Define semantic information about a string instance.

The [`format`](index.md) keyword communicates
...
> desired, the best practice is to combine this keyword with the [`pattern`](../pattern/index.md) keyword. This guarantees interoperable
...
> level (even if supported), and performing validation using the [`pattern`](../pattern/index.md) keyword.  
