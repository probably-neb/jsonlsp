...
- Original: [https://www.learnjsonschema.com/draft7/validation/propertynames/](https://www.learnjsonschema.com/draft7/validation/propertynames/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/propertyNames.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/propertyNames.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.5.8](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.5.8)
- Metaschema: `http://json-schema.org/draft-07/schema#`
- Introduced in: `draft6`

Validation succeeds if the schema validates against every property name in the instance.

The [`propertyNames`](index.md) keyword
...
such as [`properties`](../properties/index.md) and
...
> [`properties`](../properties/index.md) keyword) is
> either meaningless or leads to unsatisfiable schemas. Conversely, explicitly
> setting the [`type`](../type/index.md) keyword to
> `string` is redundant.  
