...
The [`else`](index.md) keyword restricts instances
to validate against the given subschema if the [`if`](../if/index.md) sibling keyword failed to validate against the
instance.
