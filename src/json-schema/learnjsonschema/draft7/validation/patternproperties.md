...
- Original: [https://www.learnjsonschema.com/draft7/validation/patternproperties/](https://www.learnjsonschema.com/draft7/validation/patternproperties/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/patternProperties.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/patternProperties.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.5.5](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.5.5)
- Metaschema: `http://json-schema.org/draft-07/schema#`
- Introduced in: `draft3`

Validation succeeds if, for each instance name that matches any regular expressions that appear as a property name in this keyword's value, the child instance for that name successfully validates against each schema that corresponds to a matching regular expression.

The [`patternProperties`](patternproperties.md)
...
> [`properties`](properties.md) keyword. If an
