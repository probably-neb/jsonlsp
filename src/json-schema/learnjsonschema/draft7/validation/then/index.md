...
The [`then`](index.md) keyword restricts instances
to validate against the given subschema if the [`if`](../if/index.md) sibling keyword successfully validated against the
instance.
...
> **Best Practice:**
>  The [`if`](../if/index.md),
> [`then`](index.md), and [`else`](../else/index.md) keywords can be thought of as imperative variants
