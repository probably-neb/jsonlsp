...
- Original: [https://www.learnjsonschema.com/draft7/validation/contentencoding/](https://www.learnjsonschema.com/draft7/validation/contentencoding/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/contentEncoding.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/contentEncoding.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.8.3](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.8.3)
...
The [`contentEncoding`](contentencoding.md)
...
### Valid instance: A string value encoded in Base 64 is valid

```json
"SGVsbG8gV29ybGQ=" // Hello World
```

### Valid instance: A string value that does not represent a Base 64 encoded value is valid
