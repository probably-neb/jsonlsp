...
- Original: [https://www.learnjsonschema.com/draft7/validation/if/](https://www.learnjsonschema.com/draft7/validation/if/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/if.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/if.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.6.1](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.6.1)
- Metaschema: `http://json-schema.org/draft-07/schema#`
- Introduced in: `draft7`

This keyword declares a condition based on the validation result of the given schema.

The [`if`](index.md) keyword introduces a subschema
whose evaluation result restricts instances to validate against the
[`then`](../then/index.md) or [`else`](../else/index.md) sibling subschemas (if present). Note that the
...
> **Best Practice:**
>  The [`if`](index.md),
> [`then`](../then/index.md), and [`else`](../else/index.md) keywords can be thought of as imperative variants
> of the [`anyOf`](../anyof/index.md) keyword, and both
...
> **Digging Deeper:**
>  This keyword has no effect if neither the [`then`](../then/index.md) nor [`else`](../else/index.md) keywords are declared within the same subschema.

The [`if`](index.md), [`then`](../then/index.md), and [`else`](../else/index.md) keywords are equivalent to the `?` and `:` ternary conditional operators
...
Therefore, omitting either the [`then`](../then/index.md)
or the [`else`](../else/index.md) keywords is equivalent to
...
### Valid instance: A value that matches the conditional subschema is valid

```json
[ "foo", "bar", "baz" ]
```

### Valid instance: A value that does not match the conditional subschema is still valid
