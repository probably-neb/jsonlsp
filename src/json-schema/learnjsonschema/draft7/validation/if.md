...
The [`if`](if.md), [`then`](then.md), and [`else`](else.md) keywords are equivalent to the `?` and `:` ternary conditional operators
...
Therefore, omitting either the [`then`](then.md)
or the [`else`](else.md) keywords is equivalent to
