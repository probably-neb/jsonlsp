...
- Original: [https://www.learnjsonschema.com/draft7/validation/default/](https://www.learnjsonschema.com/draft7/validation/default/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/default.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/default.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.10.2](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.10.2)
- Metaschema: `http://json-schema.org/draft-07/schema#`
- Introduced in: `draft1`

This keyword can be used to supply a default JSON value associated with a particular schema.

The [`default`](index.md) keyword declares a
