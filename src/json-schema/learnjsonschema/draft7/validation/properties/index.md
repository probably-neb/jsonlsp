...
- Original: [https://www.learnjsonschema.com/draft7/validation/properties/](https://www.learnjsonschema.com/draft7/validation/properties/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/properties.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/properties.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.5.4](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.5.4)
...
> must use the [`required`](../required/index.md) keyword
> accordingly.  
...
> the [`required`](../required/index.md) keyword. However,
