...
- Original: [https://www.learnjsonschema.com/draft7/core/ref/](https://www.learnjsonschema.com/draft7/core/ref/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/core/ref.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/core/ref.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-01#rfc.section.8.3](https://json-schema.org/draft-07/draft-handrews-json-schema-01#rfc.section.8.3)
...
> declaring the [`$ref`](ref.md) keyword is considered to
...
> and referencing purposes is through the [`$id`](id.md) keyword.
...
> [`examples`](../validation/examples.md) keyword.
...
[`$id`](id.md) keyword, or the base URI as determined by
...
resolved version of such URI through the [`$id`](id.md) keyword. If so, the reference is considered internal. This
...
### Valid instance: A non-string value is valid as the reference overrides the type declaration

```json
12345
```

### Valid instance: A string value with a length equal or higher than 2 is valid

```json
"foo"
```

### Invalid instance: A string value with a length less than 2 is invalid
