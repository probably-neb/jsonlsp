...
> declaring the [`$ref`](index.md) keyword is considered to
...
> [`allOf`](../../validation/allof/index.md).
...
> [`examples`](../../validation/examples/index.md) keyword.
...
resolved version of such URI through the [`$id`](../id/index.md) keyword. If so, the reference is considered internal. This
