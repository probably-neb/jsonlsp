...
The [`maxContains`](index.md) keyword
modifies the [`contains`](../../applicator/contains/index.md) keyword to
constrain array instances to the given maximum number of containment matches.
This keyword has no effect if the [`contains`](../../applicator/contains/index.md) keyword is not declared.

> **Digging Deeper:**
> Using [`contains`](../../applicator/contains/index.md) with both
> [`minContains`](../mincontains/index.md) and
> [`maxContains`](index.md) set to the same
...
> without making use of the [`not`](../../applicator/not/index.md)
> applicator.
