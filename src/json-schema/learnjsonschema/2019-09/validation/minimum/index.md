...
- Original: [https://www.learnjsonschema.com/2019-09/validation/minimum/](https://www.learnjsonschema.com/2019-09/validation/minimum/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/validation/minimum.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/validation/minimum.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.6.2.4](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.6.2.4)
- Metaschema: `https://json-schema.org/draft/2019-09/meta/validation`
- Introduced in: `draft1`

Validation succeeds if the numeric instance is greater than or equal to the given number.

The [`minimum`](index.md) keyword restricts number instances to be greater than or equal to
the given number.
