...
- Original: [https://www.learnjsonschema.com/2019-09/meta-data/default/](https://www.learnjsonschema.com/2019-09/meta-data/default/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/meta-data/default.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/meta-data/default.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.9.2](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.9.2)
- Metaschema: `https://json-schema.org/draft/2019-09/meta/meta-data`
- Introduced in: `draft1`

This keyword can be used to supply a default JSON value associated with a particular schema.

The [`default`](index.md) keyword declares a default instance value for a schema or any of
...
> [`default`](index.md) annotations to feed back the missing values back to it.  However,
