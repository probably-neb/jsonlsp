...
- Original: [https://www.learnjsonschema.com/2019-09/meta-data/readonly/](https://www.learnjsonschema.com/2019-09/meta-data/readonly/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/meta-data/readOnly.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/meta-data/readOnly.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.9.4](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.9.4)
...
The [`readOnly`](index.md) keyword, when set to `true`, signifies that an instance value
...
>
> Also avoid simultaneously setting this keyword and the [`writeOnly`](../writeonly/index.md) keyword to `true` for the same instance
