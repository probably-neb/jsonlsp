...
- Original: [https://www.learnjsonschema.com/2019-09/content/contentencoding/](https://www.learnjsonschema.com/2019-09/content/contentencoding/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/content/contentEncoding.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/content/contentEncoding.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.8.3](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.8.3)
...
The [`contentEncoding`](index.md) keyword signifies that a string instance value (such as a
...
> **Best Practice:**
> It is recommended to set this keyword along with the [`contentMediaType`](../contentmediatype/index.md) keyword to declare the type of data
...
### Valid instance: A string value encoded in Base 64 is valid and an annotation is emitted
...
### Valid instance: A string value that does not represent a Base 64 encoded value is valid and an annotation is still emitted
