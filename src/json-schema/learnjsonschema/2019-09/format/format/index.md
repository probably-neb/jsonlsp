...
The [`format`](index.md) keyword communicates that
...
> desired, the best practice is to combine this keyword with the [`pattern`](../../validation/pattern/index.md) keyword. This guarantees interoperable
