...
- Original: [https://www.learnjsonschema.com/2019-09/format/format/](https://www.learnjsonschema.com/2019-09/format/format/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/format/format.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/format/format.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.7.2.1](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-validation-02#rfc.section.7.2.1)
...
> desired, the best practice is to combine this keyword with the [`pattern`](../validation/pattern.md) keyword. This guarantees interoperable
...
> if supported), and performing validation using the [`pattern`](../validation/pattern.md) keyword.  
