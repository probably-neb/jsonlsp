...
- Original: [https://www.learnjsonschema.com/2019-09/core/defs/](https://www.learnjsonschema.com/2019-09/core/defs/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/core/defs.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/core/defs.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-02#rfc.section.8.2.5](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-02#rfc.section.8.2.5)
...
The [`$defs`](index.md) keyword is a container for
storing reusable schemas within a schema resource, which can be referenced
using the [`$ref`](../ref/index.md) or [`$recursiveRef`](../recursiveref/index.md) keywords. From a software engineering
