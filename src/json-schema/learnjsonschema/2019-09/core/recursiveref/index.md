...
- Original: [https://www.learnjsonschema.com/2019-09/core/recursiveref/](https://www.learnjsonschema.com/2019-09/core/recursiveref/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/core/recursiveRef.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/core/recursiveRef.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-02#rfc.section.8.2.4.2.1](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-02#rfc.section.8.2.4.2.1)
...
The [`$recursiveRef`](index.md) keyword is an
extension of the [`$ref`](../ref/index.md) keyword that enables
a schema to reference another schema by its recursive anchor, as declared by
the [`$recursiveAnchor`](../recursiveanchor/index.md) keyword.
...
> **Common Pitfall:**
> The [`$recursiveRef`](index.md) keyword only supports the special empty fragment `"#"` and it cannot be
> used with named anchors or JSON Pointer fragments.
...
> by the [`$recursiveAnchor`](../recursiveanchor/index.md).
