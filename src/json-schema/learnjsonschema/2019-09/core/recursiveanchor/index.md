...
The [`$recursiveAnchor`](index.md) keyword is
an extension of the [`$anchor`](../anchor/index.md) keyword
...
resolving this anchor using the [`$recursiveRef`](../recursiveref/index.md) keyword, the base URI of the origin is not
