...
the [`$recursiveAnchor`](recursiveanchor.md) keyword.
...
> **Common Pitfall:**
> The [`$recursiveRef`](recursiveref.md) keyword only supports the special empty fragment `"#"` and it cannot be
...
> by the [`$recursiveAnchor`](recursiveanchor.md).
