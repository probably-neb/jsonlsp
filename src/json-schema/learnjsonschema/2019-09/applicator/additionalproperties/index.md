...
The [`additionalProperties`](index.md) keyword restricts object instance
properties not described by the _sibling_ [`properties`](../properties/index.md) and [`patternProperties`](../patternproperties/index.md) keywords (if any), to validate
...
> **Common Pitfall:**
> The use of the [`properties`](../properties/index.md) keyword **does not prevent the presence
...
> [`required`](../../validation/required/index.md) keyword accordingly.
