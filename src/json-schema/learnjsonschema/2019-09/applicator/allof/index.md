...
- Original: [https://www.learnjsonschema.com/2019-09/applicator/allof/](https://www.learnjsonschema.com/2019-09/applicator/allof/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/applicator/allOf.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/2019-09/applicator/allOf.markdown)
- Specification: [https://json-schema.org/draft/2019-09/draft-handrews-json-schema-02#rfc.section.9.2.1.1](https://json-schema.org/draft/2019-09/draft-handrews-json-schema-02#rfc.section.9.2.1.1)
...
> **Common Pitfall:**
>  Wrapping a single instance of the [`$ref`](../../core/ref/index.md) or [`$recursiveRef`](../../core/recursiveref/index.md) keyword in an [`allOf`](index.md) operator is an anti-pattern.
>
> This practice has historical roots. In JSON Schema [Draft 7](/draft7) and
> earlier versions, any subschema declaring the [`$ref`](../../core/ref/index.md) keyword was considered to be a _reference object_ and
...
> the outer schema and avoid using this keyword.  
