...
keyword is a generalisation of the [`additionalItems`](../additionalitems/index.md) keyword that considers related
keywords even when they are not direct siblings of this keyword. More
specifically, this keyword is affected by occurrences of [`items`](../items/index.md), [`additionalItems`](../additionalitems/index.md), and [`unevaluatedItems`](index.md) itself, as long as the evaluate path
that led to [`unevaluatedItems`](index.md) is a _prefix_ of the evaluate path of the others.
...
> [`items`](../items/index.md) or [`additionalItems`](../additionalitems/index.md) keywords behind conditional logic
> without duplicating these keywords in every possible branch. (2) Reusing
> helpers that consist of the [`items`](../items/index.md)
> or [`additionalItems`](../additionalitems/index.md)
