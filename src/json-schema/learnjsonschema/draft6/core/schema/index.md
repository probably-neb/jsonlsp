...
- Original: [https://www.learnjsonschema.com/draft6/core/schema/](https://www.learnjsonschema.com/draft6/core/schema/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/core/schema.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/core/schema.markdown)
- Specification: [https://json-schema.org/draft-06/draft-wright-json-schema-01#rfc.section.7](https://json-schema.org/draft-06/draft-wright-json-schema-01#rfc.section.7)
...
The [`$schema`](index.md) keyword serves to explicitly
...
[`$schema`](index.md) keyword is not declared, the
schema inherits its context-specific or implementation-specific default
dialect.

> **Digging Deeper:**
>  It is common to avoid the [`$schema`](index.md) keyword when working with
...
> always explicitly set the dialect of a schema using the [`$schema`](index.md) keyword. This ensures that less strict
> implementations unambiguously know how to process the schema and don't attempt
> to guess.

Note that the [`$schema`](index.md) keyword can occur
...
> circular problem.
>
> A common occurrence of this issue is setting the [`$schema`](index.md) keyword to a relative path, which is again invalid
...
> of the [`$id`](../id/index.md) keyword (an explicit schema
> resource).
...
To debug the role of the [`$schema`](index.md)
