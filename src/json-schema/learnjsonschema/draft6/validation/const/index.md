...
- Original: [https://www.learnjsonschema.com/draft6/validation/const/](https://www.learnjsonschema.com/draft6/validation/const/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/const.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/const.markdown)
- Specification: [https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.6.24](https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.6.24)
- Metaschema: `http://json-schema.org/draft-06/schema#`
- Introduced in: `draft6`

Validation succeeds if the instance is equal to this keyword's value.

The [`const`](index.md) keyword (short for
