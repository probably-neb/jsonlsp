...
- Original: [https://www.learnjsonschema.com/draft6/validation/definitions/](https://www.learnjsonschema.com/draft6/validation/definitions/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/definitions.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/definitions.markdown)
- Specification: [https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.7.1](https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.7.1)
...
The [`definitions`](index.md) keyword is a
container for storing reusable schemas within a schema resource, which can be
referenced using the [`$ref`](../../core/ref/index.md) keyword. From a
