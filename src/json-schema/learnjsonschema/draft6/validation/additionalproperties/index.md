...
- Original: [https://www.learnjsonschema.com/draft6/validation/additionalproperties/](https://www.learnjsonschema.com/draft6/validation/additionalproperties/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/additionalProperties.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/additionalProperties.markdown)
- Specification: [https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.6.20](https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.6.20)
...
The [`additionalProperties`](index.md) keyword restricts object instance properties not described by the
_sibling_ [`properties`](../properties/index.md) and
[`patternProperties`](../patternproperties/index.md)
keywords (if any), to validate against the given subschema.

> **Common Pitfall:**
> The use of the [`properties`](../properties/index.md) keyword **does not prevent the presence of
...
> enforce the presence of certain properties, you must use the [`required`](../required/index.md) keyword accordingly.
