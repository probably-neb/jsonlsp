...
- Original: [https://www.learnjsonschema.com/draft6/validation/additionalitems/](https://www.learnjsonschema.com/draft6/validation/additionalitems/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/additionalItems.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft6/validation/additionalItems.markdown)
- Specification: [https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.6.10](https://json-schema.org/draft-06/draft-wright-json-schema-validation-01#rfc.section.6.10)
- Metaschema: `http://json-schema.org/draft-06/schema#`
- Introduced in: `draft3`

If [`items`](/draft6/validation/items) is set to an array of schemas, validation succeeds if each element of the instance not covered by it validates against this schema.
...
> [`items`](items.md) keyword is set to an array of
> schemas. If [`items`](items.md) is not present or
> is set to a schema (not an array of schemas), [`additionalItems`](additionalitems.md) has no effect and is
> ignored.

> **Common Pitfall:**
> This keyword does not prevent an array instance from being
> empty or having fewer items than the [`items`](items.md) array. If needed, use the [`minItems`](minitems.md) keyword to assert on the minimum bounds of the
> array.
