...
keyword is a generalisation of the [`items`](../applicator/items.md) keyword that considers related keywords even when they are not direct
siblings of this keyword. More specifically, this keyword is affected by
occurrences of [`prefixItems`](../applicator/prefixitems.md),
[`items`](../applicator/items.md), [`contains`](../applicator/contains.md), and [`unevaluatedItems`](unevaluateditems.md) itself, as long as the evaluate path that led to
[`unevaluatedItems`](unevaluateditems.md) is a _prefix_ of the evaluate path of the others.
...
> [`prefixItems`](../applicator/prefixitems.md) or
> [`contains`](../applicator/contains.md) keywords behind
> conditional logic without duplicating the [`items`](../applicator/items.md) keyword in every possible branch. (2) Reusing
> helpers that consist of the [`prefixItems`](../applicator/prefixitems.md), [`items`](../applicator/items.md), or [`contains`](../applicator/contains.md) keywords, while specialising the helpers as
