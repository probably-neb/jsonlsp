...
- Original: [https://www.learnjsonschema.com/draft7/validation/items/](https://www.learnjsonschema.com/draft7/validation/items/)
- Upstream source: [https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/items.markdown](https://raw.githubusercontent.com/sourcemeta/learnjsonschema.com/main/content/draft7/validation/items.markdown)
- Specification: [https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.4.1](https://json-schema.org/draft-07/draft-handrews-json-schema-validation-01#rfc.section.6.4.1)
...
- **Schema**: When set to a schema, [`items`](items.md) validates that all items in the array instance validate against the
  given subschema.

- **Array**: When set to an array of schemas, [`items`](items.md) validates each item in the array instance
  against the subschema at the corresponding position. Items beyond the length
  of the [`items`](items.md) array can be
  validated using the [`additionalItems`](additionalitems.md) keyword.

> **Common Pitfall:**
> This keyword does not prevent an array instance from being
> empty. If needed, use the [`minItems`](minitems.md) to assert on the minimum bounds of the array.
